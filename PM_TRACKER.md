...
1. **🟡 Design system overhaul** — Prompts 1-6 of 10 complete. All hardcoded sizes tokenized, item numbering for undescribed items, inline row flash replaces floating flash. Remaining: status badges, bottom sheets, screen polish, final audit. See DESIGN_SYSTEM.md §6.
